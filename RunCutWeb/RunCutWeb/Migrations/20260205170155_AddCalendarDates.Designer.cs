...
namespace RunCutWeb.Migrations
{
    ...
    [Migration("20260205170155_AddCalendarDates")]
    partial class AddCalendarDates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunCutWeb.Domain.Entities.Calendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataSetId", "ServiceId");
            ...
            modelBuilder.Entity("RunCutWeb.Domain.Entities.Trip", b =>
                {
                    b.HasOne("RunCutWeb.Domain.Entities.Calendar", "Calendar")
                        .WithMany("Trips")
